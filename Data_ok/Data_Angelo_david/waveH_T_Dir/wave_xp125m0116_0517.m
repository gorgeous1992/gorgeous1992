clc
clear all
ncfile = 'https://chlthredds.erdc.dren.mil/thredds/dodsC/frf/oceanography/waves/xp125m_tjh/xp125m.ncml';
%Get time from it.
...
%save data
% dlmwrite('WaveH_T_Dir_1617_xp125.csv', [hours16_17, waveHs16_17, waveTm16_17,...
%          depth16_17]);

%dlmwrite('WaveH_T_Dir_1617_xp150.csv', [hours16_17, waveHs16_17, waveTm16_17]);
T = table(dtt, [waveHs16_17, waveTm16_17,...
       depth16_17])
writetable(T, 'WaveH_T_Dir_1617_xp125.csv')